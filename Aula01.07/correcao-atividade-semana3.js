// Escreva uma função que recebe um email e ofusca parte do seu endereço.
// Por exemplo: jose.almir@dev.com -> j*******@dev.com

const ofuscarEmail = (email) => {
    const partes = email.split("@"); // ou fazer: const [usuario, dominio] = email.split("@"); no lugar das linhas 5, 6 e 7
